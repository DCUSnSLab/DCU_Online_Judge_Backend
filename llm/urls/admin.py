...
from ..views.admin import LLMGatewayConfigAdminAPI, LLMKeyAdminAPI, LLMKeyRevokeAPI, LLMRouteAdminAPI

urlpatterns = [
    re_path(r"^llm/gateway-config/?$", LLMGatewayConfigAdminAPI.as_view(), name="llm_gateway_config_admin_api"),
