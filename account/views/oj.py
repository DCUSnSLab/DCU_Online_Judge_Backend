...
class UserRankAPI(APIView):
    def get(self, request):
        ...
        profiles = UserProfile.objects.filter(user__admin_type__in=[AdminType.REGULAR_USER, AdminType.TA_ADMIN], user__is_disabled=False) \
            .select_related("user")
